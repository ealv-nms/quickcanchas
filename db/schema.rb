...
ActiveRecord::Schema.define(version: 2022_11_14_021850) do
  ...
  create_table "reclamos", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_reclamos_on_user_id"
  end
  ...
  create_table "rooms", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["reserva_id"], name: "index_rooms_on_reserva_id"
  end

  create_table "user_reservas", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "reserva_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["reserva_id"], name: "index_user_reservas_on_reserva_id"
    t.index ["user_id"], name: "index_user_reservas_on_user_id"
  end
